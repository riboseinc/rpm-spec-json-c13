...
%{__sed} -i 's|json-c.pc|json-c13.pc|g' Makefile.am
%{__sed} -i 's|libjson-c|libjson-c13|g' Makefile.am
%{__sed} -i 's|libjson_c|libjson_c13|g' Makefile.am
%{__sed} -i 's|/json-c|/json-c13|g' Makefile.am
%{__sed} -i 's|libjson-c|libjson-c13|g' tests/Makefile.am

%{__sed} -i 's|json-c.pc|json-c13.pc|g' configure.ac
%{__sed} -i 's|json-c-uninstalled.pc|json-c13-uninstalled.pc|g' configure.ac
%{__sed} -i 's|AM_PROG_LIBTOOL|LT_INIT|g' configure.ac

%{__sed} -i 's|ljson-c|ljson-c13|g' json-c.pc.in
%{__sed} -i 's|ljson-c|ljson-c13|g' json-c-uninstalled.pc.in
%{__mv} json-c.pc.in json-c13.pc.in
%{__mv} json-c-uninstalled.pc.in json-c13-uninstalled.pc.in
